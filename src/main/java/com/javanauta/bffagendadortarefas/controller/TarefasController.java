...
import com.javanauta.bffagendadortarefas.business.enums.StatusNotificacao;
...
public class TarefasController {
    ...
    @GetMapping("/eventos")
    @Operation(summary = "Busca tarefa por período", description = "Busca tarefas cadastradas por período")
    ...
    @GetMapping
    @Operation(summary = "Busca lista de tarefa por email de usuário",
    ...
    @PatchMapping
    @Operation(summary = "Altera status de tarefa",
